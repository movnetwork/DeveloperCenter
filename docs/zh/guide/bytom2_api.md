...
* [`list-account-votes`](#list-account-votes)
...
- `String` - *account_id*, id of account.
- `String` -*account_alias*, alias of account.
- `Integer` - *total_vote_number*, account total vote number.
- `Array of Object` - vote_details, vote array: 
  - `String` -*vote* pubkey of vote node.
  - `Integer` - *vote_number* vote number.

#### Example

```js
// Request
curl -X POST list-account-votes -d '{"account_alias": "alice", "account_id": "0BDQARM800A02"}'
...
- `String` - *id*, contract hash.
- `String` - *alias*, contract alias.
- `String` - *contract*, contract content.
- `String` - *call_program*, contract calling program.
- `String` - *register_program*, contract registration program.
...
- `String` - *id*, contract hash.
- `String` - *alias*, new contract alias.

##### Returns

none if the contract alias is updated successfully.
...
`Array of Object`, all available contracts. 
- `Object: 
  - `String` - *id*, contract hash.
  - `String` - *alias*, contract alias.
  - `String` - *contract*, contract content.
